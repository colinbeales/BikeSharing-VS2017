...
namespace Trainer.Tests
{
    ...
    public class TrainerTests
    {
        ...
        {
            CreateTrainerWith3Workouts();
            var intensity = StubTrainer.GetWorkoutIntensityCount(Intensity.Easy);
        ...
        {
            CreateTrainerWith3Workouts();
            var intensity = StubTrainer.GetWorkoutIntensityCount(Intensity.Hard);
            Assert.AreEqual(1, intensity);
        }
        ...
        {
            CreateTrainerWith3Workouts();
            var intensity = StubTrainer.GetWorkoutIntensityCount(Intensity.Medium);
            Assert.AreEqual(1, intensity);
        }
        ...
        public void TestTweetifyNoNotes()
        {
            ...
            var result = StubTrainer.TweetifyWorkouts();
